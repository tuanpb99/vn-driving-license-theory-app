...
class ResultPassScreen extends StatefulWidget {
  const ResultPassScreen({super.key});

  @override
  State<ResultPassScreen> createState() => _ResultPassScreenState();
}

class _ResultPassScreenState extends State<ResultPassScreen> {
  ...
  final List<_ResultQuestion> _questions = const [
    ...
    _ResultQuestion(num: 2, text: 'Khi gặp biển báo "Đường ưu tiên", người lái xe phải làm gì?', correctAnswer: 'B. Được quyền đi trước', userAnswer: 'B. Được quyền đi trước', isCorrect: true),
    _ResultQuestion(num: 3, text: 'Nồng độ cồn tối đa cho phép khi lái xe là bao nhiêu?', correctAnswer: 'A. 0 mg/100ml máu', userAnswer: 'C. 50 mg/100ml máu', isCorrect: false),
  ];
        ...
        children: [
          Text('ĐẬU',
              style: AppTextStyles.display.copyWith(
                  color: AppColors.accentGreen, fontSize: 32)),
          const SizedBox(height: AppSpacing.sm),
          Text('Chúc mừng bạn đã vượt qua! 🎉',
          ...
          Row(
            ...
            children: [
              _buildStat('Điểm số', '28/30', AppColors.primary),
              Container(width: 1, height: 40, color: const Color(0xFF3A3A3C)),
              _buildStat('Đúng', '28', AppColors.accentGreen),
              Container(width: 1, height: 40, color: const Color(0xFF3A3A3C)),
              _buildStat('Sai', '2', AppColors.accentRed),
            ],
          ),
        ],
      ),
  ...
  Widget _buildProgressSection() {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text('Kết quả chi tiết', style: AppTextStyles.label.copyWith(fontSize: 15, fontWeight: FontWeight.w700)),
          const SizedBox(height: AppSpacing.lg),
          _buildProgressRow('Câu đúng', 0.93, AppColors.accentGreen, '93%'),
          const SizedBox(height: AppSpacing.md),
          _buildProgressRow('Câu sai', 0.07, AppColors.accentRed, '7%'),
        ],
      ),
    );
  }
