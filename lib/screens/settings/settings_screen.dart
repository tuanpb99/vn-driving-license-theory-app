...
class _SettingsScreenState extends State<SettingsScreen> {
        ...
        child: Column(
          children: [
            ...
            AppBottomNavBar(
              currentIndex: 2,
              onTabSelected: (index) =>
                  AppTabNavigation.openTab(context, index, 2),
            ),
          ],
        ),
      ),
  ...
  Widget _buildNavBar() {
    return Container(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          Text('Thông Tin', style: AppTextStyles.h2.copyWith(fontSize: 18)),
          GestureDetector(
            onTap: () {},
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: AppSpacing.sm),
          Text('Học Viên GPLX', style: AppTextStyles.h2.copyWith(fontSize: 18)),
  ...
  Widget _buildSettingsGroup() {
    return Container(
      ...
      child: Column(
        children: [
          _buildSettingsRow(
              Icons.notifications_rounded, AppColors.primary, 'Thông báo'),
          _buildDivider(),
          _buildSettingsRow(
              Icons.dark_mode_rounded, AppColors.accentGreen, 'Chế độ tối'),
          _buildDivider(),
          _buildSettingsRow(
              Icons.language_rounded, AppColors.accentOrange, 'Ngôn ngữ'),
        ],
      ),
    );
  }
  ...
  Widget _buildSupportGroup() {
    return Container(
      ...
      child: Column(
        children: [
          _buildSettingsRow(Icons.chat_bubble_rounded, const Color(0xFFBF5AF2),
              'Hướng dẫn sử dụng'),
          _buildDivider(),
          _buildSettingsRow(
              Icons.star_rounded, AppColors.accentRed, 'Đánh giá ứng dụng'),
        ],
      ),
    );
  }

  Widget _buildSettingsRow(IconData icon, Color iconBg, String label) {
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            Icon(Icons.chevron_right_rounded, color: _subtitleColor, size: 16),
          ],
        ),
      ),
    );
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Text('Đăng xuất',
                style: AppTextStyles.label
                    .copyWith(fontSize: 15, color: AppColors.accentRed)),
          ],
        ),
      ),
    );
  ...
  Widget _buildVersion() {
    return Center(
      child: Text('OTOMOTO v2.4.1',
          style:
              AppTextStyles.caption.copyWith(color: const Color(0xFF636366))),
    );
  }
}
